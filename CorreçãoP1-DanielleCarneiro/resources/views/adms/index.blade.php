...
<div class="container well">		
	<div class="col-sm-2 "> 
		...
		<ul class="nav nav-pills nav-stacked">
			<li align= "center">
				<a href="/admin/listaAtletas">Listagem dos Atletas</a>
			</li>
			<li align= "center">
				<a href="/admin/listaRegistroEvento">Registro do Evento</a>
			</li>
			<li align= "center">
				<a href="/admin/listaRegistroAtleta">Registro do Atleta</a>
			</li>
		</ul>
	...
	<div class="col-sm-8 col-sm-offset-1" id="conteudo">
		<h3 align="center">Relatórios Gerenciais</h3>
